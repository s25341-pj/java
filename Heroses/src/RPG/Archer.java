...
public class Archer extends Heroses implements Statistic, Lvl{

    //prywatna zmienna poziomu
    private int level;
    int i;

    //utworzenie obiektu łucznika
    Archer(double strenght, double defence, double intelligence, double dextrity, double agility, double speed, int level){
            ...
            if (choice < 7 && choice > 0){
                switch (choice) {
                    case 1:
                        ...
                        break;
                    case 2:
                        super.setDefence(super.getDefence() + 1.05);
                        break;
                    case 3:
                        super.setIntelligence(super.getIntelligence() + 1.0);
                        break;
                    case 4:
                        super.setDextrity(super.getDextrity() + 1.2);
                        break;
                    case 5:
