...
public class Mage extends Heroses implements Statistic, Lvl{

    //prywatna zmienna poziomu
    private int level;
    int i;

    //utworzenie obiektu maga
    Mage(double strenght, double defence, double intelligence, double dextrity, double agility, double speed, int level){
    ...
    public void lvlUp() {
        ...
        for (i = 10; i > 0; i--){
            ...
            if (choice < 7 && choice > 0){
                switch (choice) {
                    case 1:
                        super.setStrenght(super.getStrenght() + 1.0);
                        break;
                    case 2:
                        super.setDefence(super.getDefence() + 1.0);
                        break;
                    case 3:
