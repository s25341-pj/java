...
public class Vampire extends Heroses implements Statistic, Lvl{

    //prywatna zmienna poziomu
    private int level;
    int i;

    //utworzenie obiektu wampira
    Vampire(double strenght, double defence, double intelligence, double dextrity, double agility, double speed, int level, String fly){
            ...
            if (choice < 7 && choice > 0){
                switch (choice) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        super.setSpeed(super.getSpeed() + 1.2);
                        break;
                }
            }else{
